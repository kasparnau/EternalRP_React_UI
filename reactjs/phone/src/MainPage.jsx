    ...
    <div style={{ position: "relative", height: "100%" }}>
      ...
      <div className="MainPageButtons">
        <AppButton
          ...
          content={<InfoIcon style={{ color: "white", fontSize: "2.7em" }} />}
          name="details"
        ...
        <AppButton
          ...
          content={
            <TwitterIcon style={{ color: "white", fontSize: "2.7em" }} />
          }
          name="twitter"
          setPage={props.setPage}
        />
        <AppButton
          ...
          content={
            <ContactsIcon style={{ color: "white", fontSize: "2.7em" }} />
          }
          name="contacts"
          setPage={props.setPage}
        />
        <AppButton
          ...
          content={<CallIcon style={{ color: "white", fontSize: "2.7em" }} />}
          name="calls"
          setPage={props.setPage}
        />
        <AppButton
          ...
          content={
            <ChatBubbleIcon style={{ color: "white", fontSize: "2.7em" }} />
          }
          name="messages"
          setPage={props.setPage}
        />
        <AppButton
          ...
          content={
            <LocationOnIcon style={{ color: "white", fontSize: "2.7em" }} />
          }
          name="ping"
          setPage={props.setPage}
        />
        <AppButton
          ...
          content={<MailIcon style={{ color: "white", fontSize: "2.7em" }} />}
          name="mail"
          setPage={props.setPage}
        />
        <AppButton
          ...
          content={
            <DirectionsCarIcon style={{ color: "white", fontSize: "2.7em" }} />
          }
          name="garage"
          setPage={props.setPage}
        />
        <AppButton
          ...
          content={<FlagIcon style={{ color: "white", fontSize: "2.7em" }} />}
          name="race"
          setPage={props.setPage}
        />
        <AppButton
          gradient="linear-gradient(#7ed48b, #2d6736)"
          content={<HomeIcon style={{ color: "white", fontSize: "2.7em" }} />}
          name="apartments"
          setPage={props.setPage}
        />
      </div>
